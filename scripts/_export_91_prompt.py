...
words_json = json.dumps(
    [{"word": w["arabic"], "meaning": w.get("meaning", "")} for w in fse],
...
Here are the {len(fse)} words:

{words_json}
"""

with open("generated/gpt_prompt_remaining.txt", "w", encoding="utf-8") as f:
    f.write(prompt)

print(f"Written {len(fse)} words to generated/gpt_prompt_remaining.txt")
